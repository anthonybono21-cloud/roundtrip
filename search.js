...
(function (global) {
  ...
  const SYNONYMS = {
    ...
    indoors: ['indoor', 'public-indoor'],
    vacation: ['resort', 'beach', 'island', 'ski', 'tropical'],
    vacations: ['vacation', 'resort', 'beach', 'island', 'ski'],
    holiday: ['vacation', 'resort', 'beach', 'island', 'ski'],
    resort: ['vacation', 'beach', 'ski'],
    street: ['streets', 'pedestrian', 'crowd', 'square'],
    streets: ['street', 'pedestrian', 'crowd', 'square'],
  ...
  const BROWSE = [
    ...
    ['Scenes', ['vacation', 'beach', 'city', 'street', 'skyline', 'mountain', 'volcano', 'harbor',
